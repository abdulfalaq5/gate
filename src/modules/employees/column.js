...
const employeesValidationRules = {
  create: {
    ...
    optional: ['department_id', 'company_id', 'employeeHasPermissions'] // company_id is optional and will be ignored during insert
  },
  update: {
    required: [],
    optional: ['employee_name', 'employee_email', 'title_id', 'department_id', 'company_id', 'employeeHasPermissions']
  }
}
