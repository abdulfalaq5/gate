  ...
  async getCustomers(req, res) {
    try {
      ...
      const queryParams = parseStandardQuery(modifiedReq, {
        allowedSortColumns: ['customer_name', 'customer_email', 'customer_phone', 'job_title', 'contact_person', 'customer_city', 'customer_country', 'created_at', 'updated_at'],
        defaultSort: ['created_at', 'desc'],
        searchableColumns: ['customer_name', 'customer_email', 'customer_phone', 'job_title', 'contact_person', 'customer_address', 'customer_city', 'customer_state', 'customer_country'],
        allowedFilters: ['customer_name', 'customer_email', 'customer_phone', 'job_title', 'contact_person', 'customer_city', 'customer_state', 'customer_country', 'is_delete'],
